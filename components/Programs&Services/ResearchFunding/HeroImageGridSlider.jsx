    ...
    <div>
      ...
      >
          ...
          <Image
            width={1000}
            height={1000}
            src={"/assets/images/programs-services/ResearchFunding.png"}
            className=" w-full"
          />
      </div>
      ...
      <div className="bg-primary rounded-b-lg shadow-lg">
            ...
            >
              <p className="text-white text-sm px-10 py-2">
                We collaborate with universities and medical institutions to fund research focused on innovative CHD treatments.
              </p>
            </div>
