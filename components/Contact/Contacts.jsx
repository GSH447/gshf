...
const PRIMARY_BG = "#161240";

const ContactsUsHero = () => {
  return (
    <>
      {/* Outer Container: Swapped mt-[5rem] for pt-40 to extend the background color behind the header */}
      <motion.div
      ...
      >
        ...
        <motion.div
          ...
          viewport={{ once: true }}
          className="w-full mx-auto grid gap-8 lg:gap-[4.5rem] items-center px-6 lg:px-10"
        >
          ...
          <div>
            <div className="relative flex justify-center items-center">
                ...
                <svg
                    ...
                    height="300"
                    viewBox="0 0 100 100"
                    className="absolute transform scale-x-[-1] rotate-[120deg] -ml-10 -mt-10"
                >
                    <path
          ...
          <div className="lg:w-1/2 flex flex-col justify-between gap-[2rem] mx-auto">
            <div>
                <h2 className="text-[2.5rem] font-extrabold text-white mb-2 text-center">
                    Contact us
                </h2>
            </div>
            ...
            <div>
                <p className="text-lg text-white text-center font-bold">
                    Get in touch with The Gracespring Health Foundation - we're happy to help you.
                </p>
            </div>
