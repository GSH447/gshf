...
import SponsoraDayofCare from "../../../../components/MakeADonation/CorporateSupport/SponsorADayofCare";
export const metadata = {
    title: `Sponsor a day - The Garcespring Health Foundation`,
...
export default function SponsorADay() {
  return (
