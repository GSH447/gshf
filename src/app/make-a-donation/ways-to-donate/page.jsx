...
import WaysToDonate from "../../../../components/MakeADonation/WaysToDonate";
export const metadata = {
    title: `Ways to donate - The Garcespring Health Foundation`,
...
export default function Ways2Donate() {
  return (
